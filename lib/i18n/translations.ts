...
export const messages = {
  zh: {
    ...
    about: {
      ...
      support: {
        title: "与君初相识，犹如故人归",
        supportDesc: "JSON Shuttle 免费使用，由个人维护。若对您有帮助，欢迎分享给朋友。",
        shareBtn: "分享给朋友",
  ...
  en: {
    ...
    about: {
      ...
      support: {
        ...
        supportDesc: "JSON Shuttle is free and maintained by one person. If it helps you, consider share with friends:",
